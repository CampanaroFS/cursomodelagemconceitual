package com.felipecampanaro.cursomc.resources.exceptions;
...
import com.felipecampanaro.cursomc.services.exceptions.AuthorizationException;
import com.felipecampanaro.cursomc.services.exceptions.DataIntegrityException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> authorization(AuthorizationException e, HttpServletRequest request) {
		...
		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.FORBIDDEN.value(), "Denied Acess",
